...
class poemerize 
{
	...
	public: 
		...
		string getLine() 
		{
			...
			uniform_int_distribution<int> distribution1(0, line1.size() - 1);
			uniform_int_distribution<int> distribution2(0, line2.size() - 1);
			uniform_int_distribution<int> distribution3(0, line3.size() - 1);

			switch (stanza) {
				case 1:
					randLine = distribution1(generator);
					toReturn = line1[randLine];
					break;
				case 2:
					randLine = distribution2(generator);
					toReturn = line2[randLine];					
					break;
				case 3:
					randLine = distribution3(generator);
